    ...
    <div className="flex flex-col h-full bg-slate-50 dark:bg-slate-900">
      <div className="flex-1 overflow-auto p-4 sm:p-6 lg:p-8">
        <div className="mx-auto max-w-5xl space-y-6">
          ...
          <div className="rounded-2xl border border-[#E8D8CF] bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-800">
            {/* Header / Actions */}
            <header className="mb-6 flex flex-wrap items-center justify-between gap-4 border-b border-[#E8D8CF] pb-5 dark:border-slate-700">
              {/* Filter */}
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-[#FFF8F3] text-left text-[11px] font-extrabold uppercase tracking-wider text-[#7D6F66] dark:bg-slate-700/50 dark:text-slate-300">
                  <tr>
                    <th className="px-4 py-3 rounded-tl-lg">{lang === 'en' ? 'Order' : 'Mã đơn'}</th>
                    ...
                    <th className="px-4 py-3 rounded-tr-lg">{lang === 'en' ? 'Time' : 'Thời gian'}</th>
                  </tr>
                </thead>
