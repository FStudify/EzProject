...
export const vi = {
  ...
  email_invite_sent: 'Email mời đã được gửi',
  email_invite_created: 'Đã tạo lời mời. SMTP chưa cấu hình, hãy dùng link ở tab Liên kết.',
...
export const en = {
  ...
  email_invite_created: 'Invitation created. SMTP is not configured; use the link in the Link tab.',
