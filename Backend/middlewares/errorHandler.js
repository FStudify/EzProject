...
const exactMessages = {
  ...
  'Mỗi công việc phải có deadline hợp lệ': 'Mỗi công việc phải có hạn chót hợp lệ',
  'Deadline phải sau thời điểm hiện tại ít nhất 1 giờ': 'Hạn chót phải sau thời điểm hiện tại ít nhất 1 giờ',
  'Deadline phải lớn hơn hoặc bằng ngày hiện tại': 'Hạn chót phải lớn hơn hoặc bằng ngày hiện tại',
  'Deadline phải lớn hơn hoặc bằng ngày bắt đầu': 'Hạn chót phải lớn hơn hoặc bằng ngày bắt đầu',
  'Ngày bắt đầu không hợp lệ': 'Ngày bắt đầu không hợp lệ',
  'Deadline công việc không được sau deadline dự án': 'Hạn chót công việc không được sau hạn chót dự án',
  'Deadline công việc do AI gợi ý phải sau thời điểm hiện tại ít nhất 1 giờ': 'Hạn chót công việc do AI gợi ý phải sau thời điểm hiện tại ít nhất 1 giờ',
  'Deadline công việc do AI gợi ý phải lớn hơn hoặc bằng ngày hiện tại': 'Hạn chót công việc do AI gợi ý phải lớn hơn hoặc bằng ngày hiện tại',
